...
<!-- remove hiden from everywhere  type="hidden"  add type="text"--> 
<?php

				  echo  "<h4 style='color:blue'><b><i><u>".$row_counter.". ".$fee_value->name."(".$fee_value->code.")</u></i></b></h4>";
  ?>
            <li class="item">
              ...
              &nbsp;  &nbsp;   &nbsp;   
              Discount:-<input name="discount_<?php echo $row_counter; ?>" type="text" value="0">
              <button type="button" onclick="flat(<?php echo $row_counter; ?>)">Apply BY Rs</button><br><br>
              Discount( % ):-<input name="discount_percentage_<?php echo $row_counter; ?>" type="text" value="0">
              <button type="button" onclick="check(<?php echo $row_counter; ?>)">Apply By %</button>
              &nbsp;   &nbsp;   &nbsp;     
              Fine:- <input name="fee_groups_feetype_fine_amount_<?php echo $row_counter; ?>"  type="text" value="<?php echo (int)$fees_fine_amount; ?>" onchange="fineupdate(<?php echo $row_counter; ?>)">
            <!--  <button type="button" onclick="check(<?php echo $row_counter; ?>)">reset</button>-->
                 <br><br><hr>
           
         <!--<input name="discount_<?php //echo $row_counter; ?>" type="text" value="<?php //echo  $discount; ?>">-->
          <!-- starting of product remove php tag  extra added-->
                <?php /*
...
if($fine_amount_status){
    ...
    <?php
        ...
        }elseif ($fee_value->fee_category == "transportp") {
