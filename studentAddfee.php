...
<div id="listCollectionModal" class="modal fade">
    <div class="modal-dialog">
        <form action="<?php echo site_url('studentfee/addfeegrp'); ?>" method="POST" id="collect_fee_groupP">
            <div class="modal-content">
<!-- //================ -->
...
//alert(num);
 ...
 // alert(total);
   if(num == 1){
          var value=$("input[name='discount_percentage_1']").val();
          value=($("input[name='fee_amount_1']").val() / 100)* value;
          $("input[name='discount_1']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_1']").val()- value;
          $("input[name='fee_amount_1']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 2){
          var value=$("input[name='discount_percentage_2']").val();
          value=($("input[name='fee_amount_2']").val() / 100)* value;
          $("input[name='discount_2']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_2']").val()- value;
          $("input[name='fee_amount_2']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 3){
          var value=$("input[name='discount_percentage_3']").val();
          value=($("input[name='fee_amount_3']").val() / 100)* value;
          $("input[name='discount_3']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_3']").val()- value;
          $("input[name='fee_amount_3']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 4){
          var value=$("input[name='discount_percentage_4']").val();
          value=($("input[name='fee_amount_4']").val() / 100)* value;
          $("input[name='discount_4']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_4']").val()- value;
          $("input[name='fee_amount_4']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 5){
          var value=$("input[name='discount_percentage_5']").val();
          value=($("input[name='fee_amount_5']").val() / 100)* value;
          $("input[name='discount_5']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_5']").val()- value;
          $("input[name='fee_amount_5']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 6){
          var value=$("input[name='discount_percentage_6']").val();
          value=($("input[name='fee_amount_6']").val() / 100)* value;
          $("input[name='discount_6']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_6']").val()- value;
          $("input[name='fee_amount_6']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 7){
          var value=$("input[name='discount_percentage_7']").val();
          value=($("input[name='fee_amount_7']").val() / 100)* value;
          $("input[name='discount_7']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_7']").val()- value;
          $("input[name='fee_amount_7']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 8){
          var value=$("input[name='discount_percentage_8']").val();
          value=($("input[name='fee_amount_8']").val() / 100)* value;
          $("input[name='discount_8']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_8']").val()- value;
          $("input[name='fee_amount_8']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    } 
    if(num == 9){
          var value=$("input[name='discount_percentage_9']").val();
          value=($("input[name='fee_amount_9']").val() / 100)* value;
          $("input[name='discount_9']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_9']").val()- value;
          $("input[name='fee_amount_9']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 10){
          var value=$("input[name='discount_percentage_10']").val();
          value=($("input[name='fee_amount_10']").val() / 100)* value;
          $("input[name='discount_10']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_10']").val()- value;
          $("input[name='fee_amount_10']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 11){
          var value=$("input[name='discount_percentage_11']").val();
          value=($("input[name='fee_amount_11']").val() / 100)* value;
          $("input[name='discount_11']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_11']").val()- value;
          $("input[name='fee_amount_11']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 12){
          var value=$("input[name='discount_percentage_12']").val();
          value=($("input[name='fee_amount_12']").val() / 100)* value;
          $("input[name='discount_12']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_1']").val()- value;
          $("input[name='fee_amount_12']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 13){
          var value=$("input[name='discount_percentage_13']").val();
          value=($("input[name='fee_amount_13']").val() / 100)* value;
          $("input[name='discount_13']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_13']").val()- value;
          $("input[name='fee_amount_13']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 14){
          var value=$("input[name='discount_percentage_14']").val();
          value=($("input[name='fee_amount_14']").val() / 100)* value;
          $("input[name='discount_14']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_14']").val()- value;
          $("input[name='fee_amount_14']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 15){
          var value=$("input[name='discount_percentage_15']").val();
          value=($("input[name='fee_amount_15']").val() / 100)* value;
          $("input[name='discount_15']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_15']").val()- value;
          $("input[name='fee_amount_15']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 16){
          var value=$("input[name='discount_percentage_16']").val();
          value=($("input[name='fee_amount_16']").val() / 100)* value;
          $("input[name='discount_16']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_16']").val()- value;
          $("input[name='fee_amount_16']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 17){
          var value=$("input[name='discount_percentage_17']").val();
          value=($("input[name='fee_amount_17']").val() / 100)* value;
          $("input[name='discount_17']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_17']").val()- value;
          $("input[name='fee_amount_17']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 18){
          var value=$("input[name='discount_percentage_18']").val();
          value=($("input[name='fee_amount_18']").val() / 100)* value;
          $("input[name='discount_18']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_18']").val()- value;
          $("input[name='fee_amount_18']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 19){
          var value=$("input[name='discount_percentage_19']").val();
          value=($("input[name='fee_amount_19']").val() / 100)* value;
          $("input[name='discount_19']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_19']").val()- value;
          $("input[name='fee_amount_19']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
       if(num == 20){
          var value=$("input[name='discount_percentage_20']").val();
          value=($("input[name='fee_amount_20']").val() / 100)* value;
          $("input[name='discount_20']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_20']").val()- value;
          $("input[name='fee_amount_20']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }   if(num == 21){
          var value=$("input[name='discount_percentage_21']").val();
          value=($("input[name='fee_amount_1']").val() / 100)* value;
          $("input[name='discount_21']").val(value);
          total=total-value;
          value=$("input[name='fee_amount_21']").val()- value;
          $("input[name='fee_amount_21']").val(value);
          $("#total").val(total);
         // document.getElementById("input[name='discount_1']").style.display = "none";
    }
}
...
//  console.log("total");
   if(num == 1){
     if($("input[name='discount_1']").val() !== 0){
            var value=$("input[name='discount_1']").val();
            total=total-value;
            value=$("input[name='fee_amount_1']").val() - value;
            $("input[name='fee_amount_1']").val(value);
            $("#total").val(total);
       ...
       if(num == 2){
     if($("input[name='discount_2']").val() !== 0){
            var value=$("input[name='discount_2']").val();
            total=total-value;
            value=$("input[name='fee_amount_2']").val() - value;
            $("input[name='fee_amount_2']").val(value);
            $("#total").val(total);
    ...
    if(num == 3){
     if($("input[name='discount_3']").val() !== 0){
            var value=$("input[name='discount_3']").val();
            total=total-value;
            value=$("input[name='fee_amount_3']").val() - value;
            $("input[name='fee_amount_3]").val(value);
            $("#total").val(total);
    ...
    if(num == 4){
     if($("input[name='discount_4']").val() !== 0){
            var value=$("input[name='discount_4']").val();
            total=total-value;
            value=$("input[name='fee_amount_4']").val() - value;
            $("input[name='fee_amount_4']").val(value);
            $("#total").val(total);
    ...
    if(num == 5){
     if($("input[name='discount_5']").val() !== 0){
            var value=$("input[name='discount_5']").val();
            total=total-value;
            value=$("input[name='fee_amount_5']").val() - value;
            $("input[name='fee_amount_5']").val(value);
            $("#total").val(total);
    ...
    if(num == 6){
     if($("input[name='discount_6']").val() !== 0){
            var value=$("input[name='discount_6']").val();
            total=total-value;
            value=$("input[name='fee_amount_6']").val() - value;
            $("input[name='fee_amount_6']").val(value);
            $("#total").val(total);
    ...
    if(num == 7){
     if($("input[name='discount_7']").val() !== 0){
            var value=$("input[name='discount_7']").val();
            total=total-value;
            value=$("input[name='fee_amount_7']").val() - value;
            $("input[name='fee_amount_7']").val(value);
            $("#total").val(total);
    ...
    if(num == 8){
     if($("input[name='discount_8']").val() !== 0){
            var value=$("input[name='discount_8']").val();
            total=total-value;
            value=$("input[name='fee_amount_8']").val() - value;
            $("input[name='fee_amount_8']").val(value);
            $("#total").val(total);
    ...
    if(num == 9){
     if($("input[name='discount_9']").val() !== 0){
            var value=$("input[name='discount_9']").val();
            total=total-value;
            value=$("input[name='fee_amount_9']").val() - value;
            $("input[name='fee_amount_9']").val(value);
            $("#total").val(total);
    ...
    if(num == 10){
     if($("input[name='discount_10']").val() !== 0){
            var value=$("input[name='discount_10']").val();
            total=total-value;
            value=$("input[name='fee_amount_10']").val() - value;
            $("input[name='fee_amount_10']").val(value);
            $("#total").val(total);
    ...
    if(num == 11){
     if($("input[name='discount_11']").val() !== 0){
            var value=$("input[name='discount_11']").val();
            total=total-value;
            value=$("input[name='fee_amount_11']").val() - value;
            $("input[name='fee_amount_11']").val(value);
            $("#total").val(total);
    ...
    if(num == 12){
     if($("input[name='discount_12']").val() !== 0){
            var value=$("input[name='discount_12']").val();
            total=total-value;
            value=$("input[name='fee_amount_12']").val() - value;
            $("input[name='fee_amount_12']").val(value);
            $("#total").val(total);
         }
    }
    ...
    if(num == 13){
     if($("input[name='discount_13']").val() !== 0){
            var value=$("input[name='discount_13']").val();
            total=total-value;
            value=$("input[name='fee_amount_13']").val() - value;
            $("input[name='fee_amount_13']").val(value);
            $("#total").val(total);
    ...
    if(num == 14){
     if($("input[name='discount_14']").val() !== 0){
            var value=$("input[name='discount_14']").val();
            total=total-value;
            value=$("input[name='fee_amount_14']").val() - value;
            $("input[name='fee_amount_14']").val(value);
            $("#total").val(total);
    ...
    if(num == 15){
     if($("input[name='discount_15']").val() !== 0){
            var value=$("input[name='discount_15']").val();
            total=total-value;
            value=$("input[name='fee_amount_15']").val() - value;
            $("input[name='fee_amount_15']").val(value);
            $("#total").val(total);
    ...
    if(num == 16){
     if($("input[name='discount_16']").val() !== 0){
            var value=$("input[name='discount_16']").val();
            total=total-value;
            value=$("input[name='fee_amount_16']").val() - value;
            $("input[name='fee_amount_16']").val(value);
            $("#total").val(total);
    ...
    if(num == 17){
     if($("input[name='discount_17']").val() !== 0){
            var value=$("input[name='discount_17']").val();
            total=total-value;
            value=$("input[name='fee_amount_17']").val() - value;
            $("input[name='fee_amount_17']").val(value);
            $("#total").val(total);
    ...
    if(num == 18){
     if($("input[name='discount_18']").val() !== 0){
            var value=$("input[name='discount_18']").val();
            total=total-value;
            value=$("input[name='fee_amount_18']").val() - value;
            $("input[name='fee_amount_18']").val(value);
            $("#total").val(total);
    ...
    if(num == 19){
     if($("input[name='discount_19']").val() !== 0){
            var value=$("input[name='discount_19']").val();
            total=total-value;
            value=$("input[name='fee_amount_19']").val() - value;
            $("input[name='fee_amount_19']").val(value);
            $("#total").val(total);
    ...
    if(num == 20){
     if($("input[name='discount_20']").val() !== 0){
            var value=$("input[name='discount_20']").val();
            total=total-value;
            value=$("input[name='fee_amount_20']").val() - value;
            $("input[name='fee_amount_20']").val(value);
            $("#total").val(total);
    ...
    if(num == 21){
     if($("input[name='discount_21']").val() !== 0){
            var value=$("input[name='discount_21']").val();
            total=total-value;
            value=$("input[name='fee_amount_21']").val() - value;
            $("input[name='fee_amount_21']").val(value);
            $("#total").val(total);
...
//  console.log("total");
   if(num == 1){
       ...
       if(num == 2){
            var value=$("input[name='fee_amount_2']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 3){
            var value=$("input[name='fee_amount_3']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 4){
            var value=$("input[name='fee_amount_4']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 5){
            var value=$("input[name='fee_amount_5']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 6){
            var value=$("input[name='fee_amount_6']").val();
            total=total-value;
            $("#total").val(total);
         }
    
    if(num == 7){
            var value=$("input[name='fee_amount_7']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 8){
            var value=$("input[name='fee_amount_8']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 9){
            var value=$("input[name='fee_amount_9']").val();
            total=total-value;
            $("#total").val(total);
    }
    if(num == 10){
            var value=$("input[name='fee_amount_10']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 11){
            var value=$("input[name='fee_amount_11']").val();
            total=total-value;
            $("#total").val(total);
    }
    if(num == 12){
            var value=$("input[name='fee_amount_12']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 13){
            var value=$("input[name='fee_amount_13']").val();
            total=total-value;
            $("#total").val(total);
    }
    if(num == 14){
            var value=$("input[name='fee_amount_14']").val();
            total=total-value;
            $("#total").val(total);
  }
    if(num == 15){
            var value=$("input[name='fee_amount_15']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 16){
            var value=$("input[name='fee_amount_16']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 17){
            var value=$("input[name='fee_amount_17']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 18){
            var value=$("input[name='fee_amount_18']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 19){
            var value=$("input[name='fee_amount_19']").val();
            total=total-value;
            $("#total").val(total);
         
    }
    if(num == 20){
            var value=$("input[name='fee_amount_20']").val();
            total=total-value;
            $("#total").val(total);
    }
 
    if(num == 21){
            var value=$("input[name='fee_amount_21']").val();
            total=total-value;
            $("#total").val(total);
...
function reset(num){
    document.getElementById("fee_groups_feetype_fine_amount_1").reset();
 // $("input[name='fee_amount_"+num+"']").val('');
 //$("input[name='fee_groups_feetype_fine_amount_"+num+"']").val('');
 //$("input[name='discount_percentage_"+num+"']").val('');
// $("input[name='discount_"+num+"']").val('');
//$('form :input').val('');
}
